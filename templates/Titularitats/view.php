...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Titularitat'), ['action' => 'edit', $titularitat->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Titularitat'), ['action' => 'delete', $titularitat->id], ['confirm' => __('Are you sure you want to delete # {0}?', $titularitat->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Titularitats'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Titularitat'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="titularitats view content">
            <h3><?= h($titularitat->id) ?></h3>
            <table>
                <tr>
                    <th><?= __('Nom') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($titularitat->centres)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($titularitat->centres as $centres) : ?>
                        <tr>
                            <td><?= h($centres->id) ?></td>
