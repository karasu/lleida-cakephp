...
<div class="localitats index content">
    <div class="float-right">
        <?= $this->Html->link(__('New Localitat'), ['action' => 'add'], ['class' => 'button']) ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $localitat->has('municipi') ? $this->Html->link($localitat->municipi->nom, ['controller' => 'Municipis', 'action' => 'view', $localitat->municipi->id]) : '' ?></td>
